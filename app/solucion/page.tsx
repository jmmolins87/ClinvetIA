...
export default function SolucionPage(): React.JSX.Element {
  ...
  return (
    <div className="w-full">
      ...
      <section
        className="cta-footer-section ambient-section solution-surface-cta text-foreground flex flex-col"
        aria-label={t("solution.microCta")}
      >
        <div className="flex-1 flex items-center">
          <div className="mx-auto w-full max-w-screen-2xl px-4 flex flex-col justify-center">
            <div className="max-w-3xl mx-auto">
              <SiteCta
                title={t("solution.microCta")}
                description={t("solution.cta.note")}
                demoLabel={t("solution.cta.primary")}
                demoHref="/reservar"
                roiLabel={t("solution.cta.secondary")}
                roiHref="/roi"
              />
            </div>
          </div>
